...
public class c1_Introduction extends IntroductionBase {
    ...
    public void fortune_top_five() {
        ...
        List<String> results = serviceResult.collect(Collectors.toList()).block(); //todo: change this line only
    ...
    public void leaving_blocking_world_behind() throws InterruptedException {
        ...
        //todo: change this line only
                .subscribe(e -> companyList.add(e), e-> Function.identity(), () -> serviceCallCompleted.compareAndSet(false, true))
